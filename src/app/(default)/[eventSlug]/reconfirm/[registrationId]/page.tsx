...
export const metadata = {
    title: "Attendance Confirmation | Awesome Sauce Events"
};
...
export default async function ReconfirmPage({
    ...
    try {
        await admittoRequest<void>(eventPath(eventSlug, `/registrations/${encodeURIComponent(registrationId)}/ticket-email/resend`), {
            method: "POST"
        });
        success = true;
    } catch (err: unknown) {
        ...
        <MainLayout>
            <Section headerText="Attendance Confirmation" sectionBackground={2}>
                ...
                <div className="text-light text-center">
                    ...
                    <p className="lead mt-5">Please check your inbox for your ticket.</p>
                </div>
                ) : (
                <div className="text-light text-center">
